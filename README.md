...
**CMAPSS — Turbofan Engine Degradation Simulation Data Set**
...
*Built from scratch — data loading, label engineering, sensor selection, preprocessing, model training and web deployment.*
